...
/*
 * Variante 1 da Tarefa A: laço irregular com schedule(static).
...
int main(int argc, char **argv) {
	...
	(void)chunk_str; /* chunk não é usado na variante estática */
	...
	/* Para esta variante, esperamos schedule == "static". */
	if (strcmp(schedule_str, "static") != 0) {
		fprintf(stderr,
				"Aviso: variante 1 usa sempre schedule(static); argumento schedule='%s' será ignorado.\n",
				schedule_str);
	}
